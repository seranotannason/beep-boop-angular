...
@Component({
  ...
  templateUrl: './BeepBoopAccount.component.html',
  styleUrls: ['./BeepBoopAccount.component.css'],
  providers: [BeepBoopAccountService]
})
export class BeepBoopAccountComponent implements OnInit {
  ...
  creditBalance = new FormControl('', Validators.required);
  cashBalance = new FormControl('', Validators.required);

  constructor(public serviceBeepBoopAccount: BeepBoopAccountService, fb: FormBuilder) {
